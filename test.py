...
#model_path = 'hrnetv2_w48_imagenet_pretrained.pth'
model_path="JHU-HRep_305_F1_0.676_Pre_0.764_Rec_0.607_mae_74.5_mse_332.6.pth"  #在readme的performance里面链接‘pre-trained models’链接里面下载文件夹下面pretrainedcrowedlocmodel的JHU-HRep_305_F1_0.676_Prxxxxx.pth文件  这就是最终的模型
